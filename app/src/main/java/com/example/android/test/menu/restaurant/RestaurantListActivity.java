package com.example.android.test.menu.restaurant;
...
import com.example.android.test.menu.restaurant.dummy.DummyContent;
...
public class RestaurantListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final List<DummyContent.Restaurant> mValues;
        private final boolean mTwoPane;
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DummyContent.Restaurant item = (DummyContent.Restaurant) view.getTag();
                if (mTwoPane) {
        ...
        SimpleItemRecyclerViewAdapter(RestaurantListActivity parent,
                                      List<DummyContent.Restaurant> items,
                                      boolean twoPane) {
            mValues = items;
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View view) {
                ...
                image = (ImageView) view.findViewById(R.id.image_restaurant);
            }
        }
    }
}
